...
const excludedIds = new Set([
  'andhakaranazhi_beach', 'athirapally_day_trip', 'backwater_village_tour',
  'bolgatty_palace', 'cherai_backwater_side', 'cherai_beach', 'cherai_toddy_shop',
  'chottanikkara_temple', 'grand_hyatt_kochi_bolgatty', 'infopark_food_court',
  'kadambrayar_riverside', 'kalady', 'kumbalangi_mangrove_walk',
  'kumbalangi_model_village', 'kumbalam_backwaters', 'marari_beach',
  'museum_of_kerala_history', 'north_paravur_beach', 'paravur_synagogue',
  'pathiramanal_island', 'poornathrayeesa_temple', 'thrikkakara_temple',
  'tripunithura_classical_music', 'tripunithura_hill_palace',
  'tripunithura_puttu_kadai', 'vypeen_island_cycle', 'vypin_fishing_village',
  'vypin_lighthouse', 'wonderla_kochi',
]);
